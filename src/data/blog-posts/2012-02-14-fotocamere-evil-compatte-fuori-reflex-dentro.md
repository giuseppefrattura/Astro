...
La differenza nel funzionamento di una Reflex<img class="img-fluid"  src="{{ site.url }}/assets/mirror-less-fotografia.jpg" alt="Evil Camera" width="100%" />
...
La Sony Next-7 <img class="img-fluid"  src="{{ site.url }}/assets/sony-nex-7.jpg" alt="Nex-7" width="100%" />
...
La Canon 1D, una fotocamera Full Frame di dimensioni molto grandi in commercio"]<img class="img-fluid"  src="{{ site.url }}/assets/1diin-front.jpg" alt="Canon 1D" width="100%" />
